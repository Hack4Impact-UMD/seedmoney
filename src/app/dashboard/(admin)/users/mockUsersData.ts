...
export const mockCampaigns: MockCampaign[] = [
  { campaign_id: 1, name: "Summer Kickstarter", status: "submitted_under_review" },
  ...
  { campaign_id: 10, name: "Food Bank Fundraiser", status: "submitted_under_review" },
  { campaign_id: 11, name: "Literacy Program", status: "submitted_under_review" },
  { campaign_id: 12, name: "Animal Shelter Support", status: "not_approved" },
  { campaign_id: 13, name: "Music Education Fund", status: "archived" },
  { campaign_id: 14, name: "Park Restoration", status: "in_progress" },
  { campaign_id: 15, name: "Winter Coat Drive", status: "not_approved" },
  { campaign_id: 16, name: "STEM Workshop Series", status: "in_progress" },
  { campaign_id: 17, name: "Book Drive for Schools", status: "not_approved" },
  { campaign_id: 18, name: "River Cleanup Initiative", status: "approved" },
  { campaign_id: 19, name: "After School Tutoring", status: "submitted_under_review" },
  ...
  { campaign_id: 23, name: "Bike Lane Expansion", status: "submitted_under_review" },
  { campaign_id: 24, name: "Tree Planting Drive", status: "approved" },
  { campaign_id: 25, name: "Homeless Shelter Expansion", status: "not_approved" },
